...
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-800/10 rounded-full blur-2xl" />
//       </div>
...
//             disabled={loading}
//             className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-100 disabled:opacity-70 disabled:cursor-not-allowed text-slate-900 font-body font-medium text-sm py-3 px-4 rounded-xl transition-colors shadow-sm"
//           >
//             {loading ? (
