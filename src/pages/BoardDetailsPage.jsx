...
//         <Navbar />
//         <div className="pt-14">
//           <div className="h-12 bg-slate-900 border-b border-slate-800 flex items-center px-4 gap-2 animate-pulse">
...
//       <Navbar />
//       <div className="pt-14">
//         <div className="h-12 bg-slate-900/80 backdrop-blur-sm border-b border-slate-800 flex items-center px-4 gap-2">
//           <Link
//             to="/"
