...
//             className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-body font-medium text-sm px-4 py-2.5 rounded-xl transition-colors shadow-lg shadow-indigo-500/20"
//           >
//             <svg
//               width="16"
//               height="16"
...
//             <button
//               onClick={() => setModalOpen(true)}
//               className="bg-indigo-600 hover:bg-indigo-500 text-white font-body text-sm px-4 py-2.5 rounded-xl transition-colors"
//             >
...
//                 className="group relative bg-gradient-to-br cursor-pointer rounded-xl overflow-hidden aspect-video flex flex-col justify-end p-4 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200"
...
//                     className="opacity-0 group-hover:opacity-100 bg-black/30 hover:bg-red-600/80 text-white p-1.5 rounded-lg transition-all"
//                   >
//                     <svg
//                       width="12"
//                       height="12"
...
//             <button
//               onClick={() => setModalOpen(true)}
//               className="aspect-video flex items-center justify-center gap-2 border-2 border-dashed border-slate-700 hover:border-indigo-500 rounded-xl text-slate-500 hover:text-indigo-400 font-body text-sm transition-all hover:bg-indigo-500/5"
//             >
//               <svg
//                 width="16"
//                 height="16"
...
//           <div>
//             <label className="block text-slate-400 font-body text-sm mb-1.5">
//               Board name
//             </label>
//             <input
//               autoFocus
...
//               className="w-full bg-slate-900 border border-slate-600 focus:border-indigo-500 rounded-xl px-4 py-3 text-white font-body text-sm outline-none placeholder-slate-500 transition-colors"
//             />
//           </div>
...
//                 setNewTitle("");
//               }}
//               className="text-slate-400 hover:text-white font-body text-sm px-4 py-2 rounded-xl hover:bg-slate-700 transition-colors"
//             >
//               Cancel
//             </button>
//             <button
