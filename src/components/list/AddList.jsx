...
//         className="flex-shrink-0 w-72 h-12 flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-slate-400 hover:text-white rounded-xl px-4 font-body text-sm transition-all"
//       >
//         <svg
//           width="16"
//           height="16"
...
//   return (
//     <div className="flex-shrink-0 w-72 bg-slate-800 border border-slate-700 rounded-xl p-3">
...
//           className="w-full bg-slate-900 border border-slate-600 focus:border-indigo-500 rounded-lg px-3 py-2 text-slate-200 font-body text-sm outline-none placeholder-slate-500 transition-colors"
//         />
