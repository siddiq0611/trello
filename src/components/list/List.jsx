...
//       ref={setNodeRef}
//       style={style}
//       className="bg-slate-800/80 backdrop-blur-sm border border-slate-700/60 rounded-xl w-72 flex-shrink-0 flex flex-col max-h-[calc(100vh-120px)]"
//     >
//       <div
...
//           className="font-display font-semibold text-slate-100 text-sm tracking-wide"
//           inputClassName="text-sm font-semibold"
//         />
//         <div className="flex items-center gap-1">
//           <span className="text-xs text-slate-500 font-body bg-slate-700/50 px-1.5 py-0.5 rounded">
//             {cards.length}
//           </span>
//           <button
