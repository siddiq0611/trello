...
//   return (
//     <nav className="h-14 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 flex items-center px-4 md:px-6 gap-4 fixed top-0 left-0 right-0 z-40">
...
//           />
//           <span className="text-slate-400 font-body text-sm hidden sm:block">
//             {user.displayName}
//           </span>
//           <button
//             onClick={handleSignOut}
//             className="text-slate-400 hover:text-white font-body text-sm transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-800"
//           >
//             Sign out
//           </button>
//         </div>
